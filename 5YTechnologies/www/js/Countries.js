...
function FillStatesDropDown(oCountrySel, oStateSel) {
    ...
    $('<option />').attr({ value: '', text: '--- Select/Specify State ---', selected: 'selected' }).appendTo('#' + oStateSel);
    $('#select2-contact-us-state-container').attr("title","--- Select/Specify State ---").text("--- Select/Specify State ---");

    $('#' + oStateSel + ' > option:first').trigger("click");
